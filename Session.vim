...
set shortmess=aoO
badd +60 web/channels/user_channel.ex
badd +5 spec/support/elixir_websocket_client/client.ex
badd +2 clients/node_client/index.js
badd +15 web/channels/user_socket.ex
badd +10 lib/zlack/endpoint.ex
badd +13 clients/node_client/package.json
badd +1 clients/node_client/compiled.js
badd +2 clients/node_client/.babelrc
badd +4 clients/node_client/spec/example_spec.js
badd +463 clients/node_client/spec/client_spec.js
badd +6 web/channels/test_channel.ex
badd +57 web/channels/room_channel.ex
badd +15 web/channels/guest_channel.ex
badd +3 web/controllers/api/v1/user_controller.ex
badd +31 web/controllers/api/v1/registration_controller.ex
badd +8 web/controllers/api/v1/session_controller.ex
badd +7 ~/.vimrc
badd +16 web/models/user.ex
badd +1 priv/repo/migrations/20160521053923_add_guest_field.exs
badd +12 priv/repo/migrations/20160518050227_edit_user.exs
badd +40 lib/zlack/cron.ex
badd +21 lib/zlack.ex
badd +1 web/actions/user_actions.ex
badd +1 .gitignore
badd +0 start_postgres.sh
badd +18 clients/node_client/node_modules/vows/test/reporters/reporters-test.js
badd +3 clients/node_client/node_modules/vows/lib/vows/reporters/xunit.js
badd +7 web/helpers/session.ex
badd +13 priv/repo/migrations/20160523051458_create_subscription_table.exs
badd +9 web/models/room.ex
badd +0 web/models/subscription.ex
badd +1 priv/repo/migrations/20160523054912_update_room_table.exs
badd +1 web/actions/room_actiions
badd +22 web/actions/room_actions.ex
badd +7 priv/repo/migrations/20160523081733_add_permission_class_to_room.exs
argglobal
silent! argdel *
set stal=2
...
silent! normal! zE
let s:l = 517 - ((12 * winheight(0) + 32) / 65)
...
exe 'vert 1resize ' . ((&columns * 181 + 181) / 362)
exe 'vert 2resize ' . ((&columns * 180 + 181) / 362)
tabedit ~/elixir_learning/zlack/web/models/room.ex
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((25 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
...
wincmd w
argglobal
edit ~/elixir_learning/zlack/web/channels/user_channel.ex
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((19 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
wincmd w
argglobal
edit ~/elixir_learning/zlack/web/channels/room_channel.ex
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe '4resize ' . ((&lines * 32 + 34) / 68)
exe 'vert 4resize ' . ((&columns * 180 + 181) / 362)
tabedit ~/elixir_learning/zlack/web/models/user.ex
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ~/elixir_learning/zlack/priv/repo/migrations/20160523051458_create_subscription_table.exs
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit ~/elixir_learning/zlack/web/models/room.ex
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 29 - ((20 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
wincmd w
argglobal
edit ~/elixir_learning/zlack/web/models/subscription.ex
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
