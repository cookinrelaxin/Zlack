...
set helplang=en
set operatorfunc=<SNR>28_opfunc
set ruler
...
set shortmess=aoO
badd +32 web/channels/user_channel.ex
badd +5 spec/support/elixir_websocket_client/client.ex
badd +2 clients/node_client/index.js
badd +27 web/channels/user_socket.ex
badd +10 lib/zlack/endpoint.ex
badd +12 clients/node_client/package.json
badd +1 clients/node_client/compiled.js
badd +2 clients/node_client/.babelrc
badd +4 clients/node_client/spec/example_spec.js
badd +165 clients/node_client/spec/client_spec.js
badd +6 web/channels/test_channel.ex
badd +19 web/channels/room_channel.ex
badd +13 web/channels/guest_channel.ex
badd +3 web/controllers/api/v1/user_controller.ex
badd +31 web/controllers/api/v1/registration_controller.ex
badd +18 web/controllers/api/v1/session_controller.ex
badd +7 ~/.vimrc
badd +17 web/models/user.ex
badd +9 priv/repo/migrations/20160521053923_add_guest_field.exs
badd +5 priv/repo/migrations/20160518050227_edit_user.exs
badd +40 lib/zlack/cron.ex
badd +21 lib/zlack.ex
badd +79 web/actions/user_actions.ex
badd +0 .gitignore
argglobal
silent! argdel *
set stal=2
edit clients/node_client/spec/client_spec.js
...
silent! normal! zE
let s:l = 368 - ((4 * winheight(0) + 33) / 66)
...
wincmd w
argglobal
edit ~/elixir_learning/zlack/clients/node_client/index.js
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 1resize ' . ((&columns * 181 + 181) / 362)
exe 'vert 2resize ' . ((&columns * 180 + 181) / 362)
tabedit ~/elixir_learning/zlack/web/channels/user_channel.ex
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 032|
lcd ~/elixir_learning/zlack
tabedit ~/elixir_learning/zlack/clients/node_client/package.json
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
